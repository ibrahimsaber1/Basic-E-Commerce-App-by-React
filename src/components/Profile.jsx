            ...
            <div className="card mb-4">
              <div className="card-body text-center">
                <img 
                  ...
                  style={{ width: '150px' }}
                />
                <h5 className="my-3">Ibrahim Saber</h5>
                <p className="text-muted mb-1">Full Stack Developer</p>
                <p className="text-muted mb-4">El Haram Giza ,EG</p>
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0">Ibrahim Saber</p>
                  </div>
                </div>
                <hr />
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0">ibrahimsaber622@gmail.com</p>
                  </div>
                </div>
                <hr />
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0">(20) 1027624649</p>
                  </div>
                </div>
                <hr />
                <div className="row">
                ...
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0">El Haram Giza ,EG</p>
                  </div>
                </div>
              </div>
            </div>
